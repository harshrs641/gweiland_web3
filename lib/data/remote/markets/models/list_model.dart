...
List<CryptoCurrencyResponse> cryptoCurrencyResponseFromJson(String str) => List<CryptoCurrencyResponse>.from(json.decode(str).map((x) => CryptoCurrencyResponse.fromJson(x)));

String cryptoCurrencyResponseToJson(List<CryptoCurrencyResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
